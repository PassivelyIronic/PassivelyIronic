...
[cite_start]🔬 **Currently working on**: Reproducing and optimizing a **Time-Window Prediction Model for Traumatic Hemorrhagic Shock (THS)**[cite: 3]. [cite_start]I implement **interpretable Machine Learning** (XGBoost & SHAP) using **stepped feature sets**—Vital Signs (VS), Routine Blood (RB), and Blood Gas (BG)—to predict shock onset up to 3 hours in advance[cite: 18, 102, 105, 150].
